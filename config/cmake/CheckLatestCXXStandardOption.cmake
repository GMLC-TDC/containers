...
if(MSVC)
    if(CMAKE_CXX_STANDARD GREATER_EQUAL 26)
        check_cxx_compiler_flag(/std:c++latest has_std_latest_flag)
        if(has_std_latest_flag)
            set(CXX_STANDARD_FLAG /std:c++latest)
            set(has_std_2c_flag ON)
        else()
            message(FATAL_ERROR "{$PROJECT_NAME} requires C++26 support")
        endif()
    elseif(CMAKE_CXX_STANDARD GREATER_EQUAL 23)
        ...
        if(has_std_latest_flag)
            ...
            message(FATAL_ERROR "{$PROJECT_NAME} requires C++23 support")
        endif()
